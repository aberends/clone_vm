...
# Network information
network  --bootproto=static --device=enp1s0 --gateway=192.168.122.1 --ip=192.168.122.95 --nameserver=8.8.8.8,8.8.4.4 --netmask=255.255.255.0 --ipv6=auto --activate
network  --hostname=nuc3-m-etc003.tux.m.nuc3.lan
...
volgroup etc003 --pesize=4096 pv.157
logvol /  --fstype="xfs" --size=4092 --name=root --vgname=etc003 --grow
